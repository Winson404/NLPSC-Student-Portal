<?php
	...
	if(isset($_POST['register'])) {
		...
		if(!$conn) {
            ...
            header("Location: manage_user_create.php");
	        } else {
	            	...
	            	header("Location: manage_user_create.php");
				        ...
				        $uploadOk = 0;
			                ...
			                // if everything is ok, try to upload file
			                    ...
			                    $sql = " INSERT INTO user (firstname, middlename, lastname, dob, age, email, contact, address, username, password, image)
			                    VALUES ('$firstname', '$middlename', '$lastname', '$dob', '$age', '$email', '$contact', '$address', '$username', '$password', '$file')";
			                          if(mysqli_query($conn, $sql)) {
			                          $_SESSION['success']  = "You have successfully added new user information.";
