...
<!-- Page Content  -->
    <div id="content" class="p-4 p-md-5 pt-5">
        <div class="card p-5">
          <h4 class="bg-light p-3" align="center"><strong>Create Activity</strong></h4>  
          <hr>
        ...
        <?php unset($_SESSION['exists']); } ?>
          ...
          <div class="row">
            ...
            <div class="col-md-12" >
              <div class="contact-form">
                <div class="form-group has-feedback">
                  <label for=""><b>Activity Topic</b></label>
            ...
            <div class="col-md-12" >
              <div class="contact-form">
                <div class="form-group has-feedback">
                  <label for=""><b>Activity Description</b></label>
            ...
            <div class="col-md-12">
              <hr>
              <button type="submit" class="btn btn-primary" name="save_activity">Save Activity</button>
            </div>
          </div>
        </form>
    </div>
