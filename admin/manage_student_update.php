 ...
 <!-- Page Content  -->
      <div id="content" class="p-4 p-md-5 pt-5">
        <div class="card p-3">
          <h4 class="bg-light p-3" align="center"><strong>Edit Student Information</strong></h4>  
    ...
    <form action="manage_student_update_code.php" method="POST">
    <div class="row">
      <div class="col-md-4" >
        <div class="contact-form">
          <div class="form-group has-feedback">
            <input type="hidden" class="form-control" value="<?php echo $row['Id']; ?>" name="student_id">
            <label for=""><b>Student ID No:</b></label>
            <input type="text" class="form-control" name="id_no" value="<?php echo $row['id_no']; ?>">
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="contact-form">
          <div class="form-group has-feedback">
            <?php 
              include '../config.php';
              $stud_id = $_GET['id'];
              $dept = mysqli_query($conn, "SELECT * FROM student JOIN department ON student.dept_id=department.Id AND student.Id='$stud_id'");
              while ($dept_name = mysqli_fetch_array($dept)) {
             ?>
              <label for=""><b>Department</b></label>
              <input type="hidden" class="form-control" name="department" value="<?php echo $dept_name['Id']; ?>" required>
              <input type="text" class="form-control" value="<?php echo $dept_name['dept_name']; ?>" required>
            <?php } ?>
          </div>
        </div>
      </div>
        ...
        <div class="contact-form">
          <div class="form-group has-feedback">
            <label for=""><b>Year level</b></label>
              <input type="text" class="form-control" name="yearlevel" value="<?php//echo $row['year_level']; ?>" required >
          </div>
        </div>
      </div> -->
      <!-- <div class="col-md-4" >
      ...
      <!-- <div class="col-md-4" >
        <div class="contact-form">
          <div class="form-group has-feedback">
            ...
            <input type="file" class="form-control" name="fileToUpload" value="<?php echo $row['images']; ?>" required> 
          </div>
        </div>
      </div> -->
